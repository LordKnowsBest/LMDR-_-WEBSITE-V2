...
function isIpAllowed(partner, ipAddress) {
  ...
  if (!ipAddress) return false; // Fail closed if whitelist exists but IP is missing
...
/**
 * Secure Rate Limit Bypass Logic
 * Finding: Removed vulnerable explicit header bypass.
 */
