...
ROS.config = {
  ...
  // ── Feature Flags ──
  features: {
    NLU_ENABLED: false,        // Claude API intent detection
    NBA_ENABLED: false,        // Next Best Action chips
    DARK_MODE_ENABLED: false,  // Theme toggle in settings
    THEME_MODE: 'light'
  },
  ...
  drawers: [
    {
      ...
      tools: ['search', 'ai-match', 'alerts', 'job-boards', 'intel', 'predict']
    },
    {
      id: 'pipe',
...
ROS.TOOL_REGISTRY = [
  ...
  { id: 'job-boards', name: 'Job Boards',  desc: 'Indeed, Zip',       icon: 'campaign',       color: '#0284c7', gradient: 'from-sky-500 to-blue-600',         view: null,          drawer: 'discover', status: 'future' },
  ...
  { id: 'sms',        name: 'SMS',         desc: 'SMS campaigns',     icon: 'sms',            color: '#f97316', gradient: 'from-orange-400 to-red-500',        view: null,          drawer: 'pipe',     status: 'future' },
  { id: 'email',      name: 'Email',       desc: 'Email drips',       icon: 'forward_to_inbox', color: '#eab308', gradient: 'from-yellow-500 to-amber-600',   view: null,          drawer: 'pipe',     status: 'future' },
  ...
  { id: 'automate',   name: 'Automate',    desc: 'Workflow rules',    icon: 'bolt',           color: '#eab308', gradient: 'from-yellow-400 to-lmdr-yellow',    view: null,          drawer: 'pipe',     status: 'ready' },
  ...
  { id: 'docs',       name: 'Docs',        desc: 'CDL, medical',      icon: 'folder_supervised', color: '#0d9488', gradient: 'from-teal-400 to-cyan-600',     view: null,          drawer: 'onb',      status: 'future' },
  { id: 'bg-check',   name: 'BG Check',    desc: 'Background check',  icon: 'shield_person',  color: '#0891b2', gradient: 'from-cyan-500 to-blue-600',        view: null,          drawer: 'onb',      status: 'future' },
  { id: 'drug-test',  name: 'Drug Test',   desc: 'Quest/LabCorp',     icon: 'biotech',        color: '#059669', gradient: 'from-emerald-500 to-green-600',     view: null,          drawer: 'onb',      status: 'future' },
  { id: 'orient',     name: 'Orient.',     desc: 'Calendar',          icon: 'event_available', color: '#16a34a', gradient: 'from-green-500 to-emerald-600',    view: null,          drawer: 'onb',      status: 'future' },
  { id: 'comply',     name: 'Comply',      desc: 'Regulatory',        icon: 'gavel',          color: '#0d9488', gradient: 'from-teal-600 to-emerald-700',      view: null,          drawer: 'onb',      status: 'future' },
  ...
  { id: 'cost-hire',  name: 'Cost/Hire',   desc: 'Budget',            icon: 'payments',       color: '#475569', gradient: 'from-slate-600 to-slate-800',       view: 'funnel',      drawer: 'anl',      status: 'consolidate', iconColor: 'text-lmdr-yellow' },
  ...
  // ── Rank & Compete (2) ──
  { id: 'leaderboard', name: 'Leaderboard', desc: 'Rankings',         icon: 'leaderboard',    color: '#f59e0b', gradient: 'from-amber-400 to-orange-500',      view: 'leaderboard', drawer: 'rank',     status: 'consolidate' },
  { id: 'badges',      name: 'Badges',      desc: 'Achievements',     icon: 'stars',          color: '#f97316', gradient: 'from-orange-400 to-red-500',        view: 'leaderboard', drawer: 'rank',     status: 'consolidate' }
];
